...
You can then execute your native executable with: `./target/via-clothing-order-service-1.0-SNAPSHOT-runner`

If you want to learn more about building native executables, please consult <https://quarkus.io/guides/maven-tooling>.

## Related Guides

- Amazon Lambda ([guide](https://docs.quarkiverse.io/quarkus-amazon-services/dev/amazon-lambda.html)): Connect to Amazon
  Lambda
